...
**Usage Data:** We automatically collect information about your use of our services, including data requests, timestamps, coverage selections, and performance metrics.
...
• Comply with legal obligations`,
  },
  {
    ...
    content: `**Input Data:** When you use our data services, your requests are processed to generate market responses. We do not use your inputs to train external systems without explicit consent.

**Output Data:** Market outputs are returned to you and may be temporarily cached for performance optimization.

**Retention:** Inputs and outputs are retained for up to 30 days for abuse prevention and debugging purposes, unless you opt out or request earlier deletion.

**Service Improvement:** We may use aggregated, anonymized usage patterns to improve our services, but this never includes identifiable content from your requests.`,
  },
  {
...
**Protection:** To protect the rights, property, and safety of Entrestate, our users, or others.
...
• **Access Logs:** Retained for 30 days by default
...
To exercise these rights, contact us at privacy@entrestate.ai.`,
  },
  {
...
If you believe we have collected information from a child, please contact us immediately at privacy@entrestate.ai, and we will take steps to delete such information.`,
  },
  {
...
**Privacy Inquiries:** privacy@entrestate.ai

**Data Protection Officer:** dpo@entrestate.ai

**Mailing Address:**
Entrestate, Inc.
Attn: Privacy Team
123 Market Boulevard, Suite 400
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-8 md:p-12">
              <p className="text-muted-foreground mb-8 leading-relaxed">
                At Entrestate, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose,
              ...
              <div className="mt-12 pt-8 border-t border-border/50">
                <p className="text-sm text-muted-foreground">
                  By using Entrestate, you acknowledge that you have read and understood this Privacy Policy. See also our{" "}
