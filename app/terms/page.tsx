...
const sections = [
  {
    ...
    content: `By accessing or using Entrestate's services, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing our services.

These terms apply to all users, including visitors, registered users, and data consumers. We reserve the right to modify these terms at any time, and your continued use of the service constitutes acceptance of those modifications.`,
  },
  {
    title: "2. Description of Service",
    content: `Entrestate provides market data services and decision tools for real estate teams. Our services include:

• Live market data feeds
• Market scoring and safety tiers
...
We reserve the right to suspend or terminate accounts that violate these terms or engage in fraudulent activity.`,
  ...
  {
    title: "4. Data Access and Limits",
    content: `Your use of Entrestate data services is subject to usage limits as specified in your plan. You agree to:

• Not exceed your allocated limits or attempt to circumvent them
• Not use the data service for any illegal or unauthorized purpose
...
Excessive usage or abuse may result in throttling, suspension, or termination of your access.`,
  },
  {
...
You are responsible for all taxes associated with your use of our services, excluding taxes based on our net income.`,
  },
  {
    ...
    content: `Entrestate retains all rights, title, and interest in our services, including all intellectual property rights. You retain ownership of:

• Your application code and configurations
• Data you submit to our services
• Outputs generated through your use of the data service
...
• Attempt to reverse engineer our data pipelines or systems
• Resell data access without authorization
...
Violation of these restrictions may result in immediate termination without refund.`,
  },
  {
    ...
    content: `TO THE MAXIMUM EXTENT PERMITTED BY LAW, ENTRESTATE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR GOODWILL.
...
Our total liability for any claims arising from these terms or your use of our services shall not exceed the amount you paid us in the twelve months preceding the claim.`,
  },
  {
    ...
    content: `You agree to indemnify, defend, and hold harmless Entrestate and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:
...
Email: legal@entrestate.ai
Address: 123 Market Boulevard, Suite 400, San Francisco, CA 94105

For general support inquiries, please visit our documentation or contact support@entrestate.ai.`,
  },
]
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-8 md:p-12">
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Welcome to Entrestate. These Terms of Service ("Terms") govern your access to and use of Entrestate's
                products and data services. Please read these terms carefully before using our services.
              </p>
              ...
              <div className="mt-12 pt-8 border-t border-border/50">
                <p className="text-sm text-muted-foreground">
                  By using Entrestate, you acknowledge that you have read, understood, and agree to be bound by these Terms
