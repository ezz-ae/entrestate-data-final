...
export default function StyleGuidePage() {
  ...
  const codeExample = `import { createClient } from '@entrestate/sdk'
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              A comprehensive guide to the colors, typography, components, and patterns used throughout the Entrestate
              template.
            </p>
          </div>
          ...
          <section id="typography" className="mb-20">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-muted-foreground mb-8">
                Space Grotesk is the primary font family, paired with JetBrains Mono for code.
              </p>
              ...
              <Card className="bg-card/50 border-border/50">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-secondary/50 rounded-lg">
                    <span className="font-sans text-lg">Space Grotesk - The quick brown fox</span>
                    <span className="text-sm text-muted-foreground font-mono">font-sans</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-secondary/50 rounded-lg">
                    <span className="font-mono text-lg">JetBrains Mono - The quick brown fox</span>
                ...
                <Card className="bg-card/50 border-border/50">
                  ...
                  <CardContent className="space-y-4">
                    <div className="p-4 bg-secondary/50 rounded-lg">
                      ...
                      <Link href="/docs" className="nav-link-hover text-foreground font-medium">
                        Hover over me
                      </Link>
                    </div>
                    <div className="p-4 bg-secondary/50 rounded-lg">
