    ...
    >
      <div className="flex items-center gap-3 border-b border-border bg-secondary/50 px-4 py-3">
        ...
        <div className="flex-1">
          <h3 className="text-sm font-semibold text-foreground">Signal Index</h3>
          <p className="text-xs text-muted-foreground">Indexes signals for retrieval</p>
        </div>
      ...
      <div className="space-y-2 p-4">
        <div className="flex justify-between text-xs">
          <span className="text-muted-foreground">Index depth:</span>
          <span className="font-mono text-foreground">Standard</span>
        </div>
      </div>
